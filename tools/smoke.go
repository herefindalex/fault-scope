...
func smoke() error {
	...
	for _, route := range []string{
		...
		"/cases/which-event-is-actually-newer/",
		"/cases/the-read-succeeded-is-it-fresh-enough/",
		"/cases/did-cancellation-stop-the-work/",
		"/cases/it-restarted-what-did-it-forget/",
		...
		"/en/cases/which-event-is-actually-newer/",
		"/zh-TW/cases/which-event-is-actually-newer/",
		"/ar/cases/which-event-is-actually-newer/",
		"/en/cases/the-read-succeeded-is-it-fresh-enough/",
		"/zh-TW/cases/the-read-succeeded-is-it-fresh-enough/",
		"/ar/cases/the-read-succeeded-is-it-fresh-enough/",
		"/en/cases/did-cancellation-stop-the-work/",
		"/zh-TW/cases/did-cancellation-stop-the-work/",
		"/ar/cases/did-cancellation-stop-the-work/",
		"/en/cases/it-restarted-what-did-it-forget/",
		"/zh-TW/cases/it-restarted-what-did-it-forget/",
		"/ar/cases/it-restarted-what-did-it-forget/",
	...
	for _, check := range []struct {
		...
		{"HEAD", "/en/cases/which-event-is-actually-newer/", 200, "no-cache"},
		{"HEAD", "/en/cases/the-read-succeeded-is-it-fresh-enough/", 200, "no-cache"},
		{"HEAD", "/en/cases/did-cancellation-stop-the-work/", 200, "no-cache"},
		{"HEAD", "/en/cases/it-restarted-what-did-it-forget/", 200, "no-cache"},
