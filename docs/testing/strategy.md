...
| Browser E2E | `pnpm --dir web e2e` after `go run ./tools build` | All 20 public locales traverse Cases 01–06 from the embedded binary; Guided, Challenge, Deep Dive, visuals, navigation, and progress are exercised |
