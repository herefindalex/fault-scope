...
The [registry](../../web/i18n/registry.json) lists 20 locales. English is the source locale. Every locale has complete shared UI and Case 01–08 catalogs. The 19 non-English locales are **unreviewed beta translations**. Arabic uses RTL document layout; source code stays LTR.
