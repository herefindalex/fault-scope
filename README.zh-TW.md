...
**人類語言（Human Locale）**改變介面與說明；**程式碼視角（Code Lens）**改變程式碼呈現，兩者互不影響。例如可以選擇繁體中文說明搭配 Go 程式碼。目前有 20 個人類語言路由，但英文內容完整，其他 19 個語言仍是**未經人工審校的 beta 翻譯**，缺漏訊息會回退到英文。程式碼視角有 Go、TypeScript、Python、Java、PHP、C、C++。
